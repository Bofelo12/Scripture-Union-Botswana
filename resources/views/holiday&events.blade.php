...
<body>
  ...
  <div class="container-fluid" style="background-image: url('img/holid.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed; 
  background-size: 100% 30%;">
    <br>
    <h1 style="color:#ff7a04;">HOLIDAY & EVENTS</h1>
    <hr>
  </div>
  ...
  <div class="container">
    ...
    <h3 style="text-align: center; color: rgb(236,122,40);">About SU Holidays & Events</h3>
    <br>
    <div class="container justify-content-center">
      <p>Scripture Union camps and holidays are a great experience! We have a huge
        range of fun on offer, from camping in tents to sleeping in log cabins, and
        from outdoor activity centres to luxury boarding schools.</p>
      <p>Choose from multi-activity residentials with a mix of sport, adventure, arts and
        crafts, fun and games, or go for one of our specialist holidays which focus
        on a specific activity. examples include:
        performing arts and baking.</p>
      <p>Looking for something local? We have holiday clubs and other activities on parks,
        schools and in community centres around Botswana.
      </p>
      <p>
        We have been organising holidays and activities for children, young people
        and families for more than 100 years. Each of our events is unique, but they
        all share the core values of fun, friendship and faith exploration.
      </p>
      <p>
        All our holidays and other events are run by high-quality volunteer teams
        (suitably vetted and trained).
      </p>
    </div>
  </div>
